    ...
    return (
        <button
            ...
            className="relative w-16 h-8 rounded-full transition-all duration-300
                     ...
                     hover:bg-slate-600 light:hover:bg-slate-400
                     border-2 border-slate-600 light:border-slate-400
                     shadow-lg"
        ...
        >
            ...
            <div
                className={`absolute top-0.5 w-6 h-6 rounded-full transition-all duration-300
                          ...
                          ${theme === "dark"
                        ? "left-0.5 from-slate-400 to-slate-200"
                        : "left-8 from-yellow-400 to-orange-400"
                    }`}
            >
                {/* Icon */}
